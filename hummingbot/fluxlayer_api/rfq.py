...
from hummingbot.fluxlayer_api.exchange_constants import get_supported_exchanges, get_exchange_config, validate_exchange_support
...
async def initialize_exchange(exchange_name: str = "binance", trading_pairs: list = None):
    ...
    if not validate_exchange_support(exchange_name):
