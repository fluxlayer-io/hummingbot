...
import hummingbot.connector.exchange.fluxlayer.fluxlayer_constants as CONSTANTS
...
def public_rest_url(path_url: str, domain: str = CONSTANTS.DEFAULT_DOMAIN) -> str:
    ...
    :param domain: the Fluxlayer domain to connect to ("com" or "us"). The default value is "com"
